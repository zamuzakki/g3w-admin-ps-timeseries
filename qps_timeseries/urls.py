...
urlpatterns = [
    ...
    # For projects
    # ------------
    path('projects/', login_required(QpsTimeseriesProjectListView.as_view()), name='qpstimeseries-project-list'),
    path('projects/add/', login_required(QpsTimeseriesProjectAddView.as_view()), name='qpstimeseries-project-add'),
    # path('projects/update/<int:pk>/', login_required(SimpleRepoProjectUpdateView.as_view()),
    #      name='qpstimeseries-project-update'),
    path('projects/delete/<int:pk>/', login_required(QpsTimeseriesProjectDeleteView.as_view()),
         name='qpstimeseries-project-delete'),

    # For layers
    # ----------
    path('projects/<int:qps_prj_pk>/layers/', login_required(QpsTimeseriesLayersListView.as_view()),
